...
@MyComponentScan2(basePackages = "com.wzp.demo.thinking.in.spring.annotation") // 指定 Class-Path(s)
//@ComponentScan(value = "com.wzp.demo.thinking.in.spring.annotation") // 指定 Class-Path(s)

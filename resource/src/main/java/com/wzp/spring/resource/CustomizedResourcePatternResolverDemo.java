 ...
 */
package com.wzp.spring.resource;

import com.wzp.spring.resource.util.ResourceUtils;
...
public class CustomizedResourcePatternResolverDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // *.java
        String currentPackagePath = "/" + System.getProperty("user.dir") + "/thinking-in-spring/resource/src/main/java/com/wzp/spring/resource/";
